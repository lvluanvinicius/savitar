...
Route::middleware(['auth'])->prefix("app")->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::middleware("collections")->group(function () {
            ...
            Route::put("collections-dbms-create-graphs", [App\Http\Controllers\Admin\CollectionsControllers::class, "create_graphs"])->name("admin.collections.dbms.create.graphs");

        });


        // VariablesGlobalsController Group
        Route::middleware('variablesGlobals')->group(function () {
            Route::get('', [App\Http\Controllers\Admin\VariablesGlobalsController::class, "variablesIndex"])->name('admin.variables.globals.index');
        });

...
Trait AppMessages {
    ...
    private $appsuccess = [
        ...
        "SuccessDeleteUser" => "Usuário excluído com sucesso.",
        ...
        "SuccessEquipmentCreatedGraphs" => "Configurações dos gráficos criados com sucesso.",
    ];
    ...
    private $apperror = [
        ...
        "ErrorUnauthorizedRouteDeleteUser" => "Você não possui permissão para excluir usuários.",
        ...
        "ErrorNotExcludeUserGroup" => "Erro ao tentar excluir esse grupo de usuário.",
        ...
        "ErrorUnauthorizedRouteDeleteGroup" => "Você não possui permissão para excluir grupos de usuários.",
        ...
        "ErrorEquipmentSelectedForGraphs" => "Identificador de equipamento não informado, por favor, selecione um equipamento no ícone de gráfico.",
        "ErrorFileNotExistsCSVTask" => "Falha ao tentar localizar o arquivo selecionado ou ele não existe.",
        "ErrorEquipmentCreatedGraphs" => "Houve uma falha ao tentar criar as configurações dos gráficos."
    ];
}

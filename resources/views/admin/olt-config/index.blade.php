                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-buttons-group">
                                        ...
                                        <div class="ml-1">
                                        @if(!$olt->CREATE_GRAPH)
                                            <x-actions troute="admin.collections.dbms.create.graphs"
                                                ticonAndClass="fas fa-plus-circle fa-1x text-primary"
                                                methodText="PUT"
                                                iduser="{{ $olt->id }}" />

                                        @elseif($olt->CREATE_GRAPH)
                                            <x-actions troute="admin.collections.dbms.dashboard"
                                                ticonAndClass="fa fa-chart-line fa-1x text-success"
                                                iduser="{{ $olt->id }}" />
                                        @endif
                                        </div>
